...
public class Test2TemplateInvert {
        ...
        for(int i = 0; i < problems.size(); i++) {
            ...
            for (int tabuSize = 3; tabuSize < MAX_TABU_SIZE; tabuSize++) {
                for (int repeat = 0; repeat < REPEATS; repeat++) {
                    ...
                    Tabu.tabuSearch(new AcceleratedInvertMultithreadedBrowser(), new IterationStopCondition(ITERATIONS), NeighborExtended.neighborExtended(problems.get(i)), problems.get(i), tabuSize, false, Long.MAX_VALUE);
