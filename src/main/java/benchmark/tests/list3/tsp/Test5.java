...
public class Test5 {
    ...
    public static final String NEIGHBORHOOD = "MultithreadedInvert";
    public static final String OUTPUT_PATH = "C:\\Users\\Admin\\Desktop\\TSPDATASYMETRIC\\5";
    ...
    public static final int BEES = 10000;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 0; i < problems.size(); i++) {
            ...
            for (int repeat = 0; repeat < REPEATS; repeat++) {
                ...
                MultiArtificialBeeColony.beeColony(new TimeStopCondition(TIME_LIMIT), problems.get(i), BEES, RESET);
                results.add(new ArrayList<>(MultiArtificialBeeColony.snapshotDataArrayList));
            }
