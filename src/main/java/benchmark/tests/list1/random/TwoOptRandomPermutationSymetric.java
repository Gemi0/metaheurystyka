...
public class TwoOptRandomPermutationSymetric extends RandomRepeatingBenchmark {

    public TwoOptRandomPermutationSymetric() {
        minDistance = 1;
        maxDistance = 10000;
        symetric = true;
        minN = 10;
    ...
    public static void main(String[] args) {
        TwoOptRandomPermutationSymetric benchmark = new TwoOptRandomPermutationSymetric();
        benchmark.runBenchmark();
        benchmark.saveResults("C:\\Users\\Admin\\Documents\\bench\\RandomTests\\TwoOptRandomPermutation\\Symetric");
    }
}
